...
export const HttpMethodSchema = Type.Union([
    ...
    Type.Literal(HttpMethod.CONNECT), Type.Literal(HttpMethod.TRACE)]);
...
export const FrequencySchema = Type.Object({
  every: Type.Number(),
  unit: Type.Union([Type.Literal(FrequencyUnit.MINUTE), Type.Literal(FrequencyUnit.HOUR), Type.Literal(FrequencyUnit.DAY)]),
});
...
export const AssertionsSchema = Type.Object({
  ...
  assertions: Type.Array(Type.Union([JSONAssertionSchema, XMLAssertionSchema, TextAssertionSchema])),
});
export type Assertions = Static<typeof AssertionsSchema>;



export const NodeTypeSchema = Type.Union([Type.Literal(NodeType.ENDPOINT), Type.Literal(NodeType.WAIT), Type.Literal(NodeType.ASSERTION)]);
